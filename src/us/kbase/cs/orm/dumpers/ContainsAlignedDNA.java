...
public class ContainsAlignedDNA extends Dumper {  	
    ...
    private ContainsAlignedDNA() throws IOException{		
        super();							
    }										

    public static ContainsAlignedDNA newDumper() throws IOException{	
        return new ContainsAlignedDNA();			
    }								
    ...
    public ContainsAlignedDNA withFrom_link(String fromLink) {				
        this.fromLink = fromLink;						
        return this;						
    }										
    ...
    public ContainsAlignedDNA withTo_link(String toLink) {				
        this.toLink = toLink;						
        return this;						
    }										
    ...
    public ContainsAlignedDNA withIndex_in_concatenation(Integer indexInConcatenation) {				
        this.indexInConcatenation = indexInConcatenation;						
        return this;						
    }										
    ...
    public ContainsAlignedDNA withBeg_pos_in_parent(Integer begPosInParent) {				
        this.begPosInParent = begPosInParent;						
        return this;						
    }										
    ...
    public ContainsAlignedDNA withEnd_pos_in_parent(Integer endPosInParent) {				
        this.endPosInParent = endPosInParent;						
        return this;						
    }										
    ...
    public ContainsAlignedDNA withParent_seq_len(Integer parentSeqLen) {				
        this.parentSeqLen = parentSeqLen;						
        return this;						
    }										
    ...
    public ContainsAlignedDNA withBeg_pos_aln(Integer begPosAln) {				
        this.begPosAln = begPosAln;						
        return this;						
    }										
    ...
    public ContainsAlignedDNA withEnd_pos_aln(Integer endPosAln) {				
        this.endPosAln = endPosAln;						
        return this;						
    }										
    ...
    public ContainsAlignedDNA withKb_feature_id(String kbFeatureId) {				
        this.kbFeatureId = kbFeatureId;						
        return this;						
    }										
