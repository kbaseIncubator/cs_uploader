...
public class ContainsAlignedProtein extends Dumper {  	
    ...
    private ContainsAlignedProtein() throws IOException{		
        super();							
    }										

    public static ContainsAlignedProtein newDumper() throws IOException{	
        return new ContainsAlignedProtein();			
    }								
    ...
    public ContainsAlignedProtein withFrom_link(String fromLink) {				
        this.fromLink = fromLink;						
        return this;						
    }										
    ...
    public ContainsAlignedProtein withTo_link(String toLink) {				
        this.toLink = toLink;						
        return this;						
    }										
    ...
    public ContainsAlignedProtein withIndex_in_concatenation(Integer indexInConcatenation) {				
        this.indexInConcatenation = indexInConcatenation;						
        return this;						
    }										
    ...
    public ContainsAlignedProtein withBeg_pos_in_parent(Integer begPosInParent) {				
        this.begPosInParent = begPosInParent;						
        return this;						
    }										
    ...
    public ContainsAlignedProtein withEnd_pos_in_parent(Integer endPosInParent) {				
        this.endPosInParent = endPosInParent;						
        return this;						
    }										
    ...
    public ContainsAlignedProtein withParent_seq_len(Integer parentSeqLen) {				
        this.parentSeqLen = parentSeqLen;						
        return this;						
    }										
    ...
    public ContainsAlignedProtein withBeg_pos_aln(Integer begPosAln) {				
        this.begPosAln = begPosAln;						
        return this;						
    }										
    ...
    public ContainsAlignedProtein withEnd_pos_aln(Integer endPosAln) {				
        this.endPosAln = endPosAln;						
        return this;						
    }										
    ...
    public ContainsAlignedProtein withKb_feature_id(String kbFeatureId) {				
        this.kbFeatureId = kbFeatureId;						
        return this;						
    }										
